...
class CollateralLoanScene01(Scene):
    def construct(self):
        ...
        # shift_amount = (loan_bar.width - new_width100) / 2 
        # tempFactor.set_color(color=WHITE)
        # self.play(UpdateFromAlphaFunc(tempFactor[1], update_percentage), loan_bar.animate.stretch_to_fit_width(new_width100).shift(LEFT * shift_amount), run_time=2, rate_func=linear)
